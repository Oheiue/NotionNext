...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '生活的牛马TT', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion.squareone.click', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion 等一盏灯', // 网站关键词 英文逗号隔开
