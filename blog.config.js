...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '生活的牛马', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion.squareone.clik', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '等一盏灯', // 网站关键词 英文逗号隔开
